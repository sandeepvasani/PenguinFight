...
@interface CCParallaxScrollNode : CCNode {
	NSMutableArray *scrollOffsets;
	CCSpriteBatchNode *batch;
}

@property(nonatomic, readwrite) NSMutableArray *scrollOffsets;
...
-(void) addInfiniteScrollWithObjects:(NSArray*)objects Z:(NSInteger)z Ratio:(CGPoint)ratio Pos:(CGPoint)pos Dir:(CGPoint)dir;
